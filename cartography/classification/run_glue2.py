    ...
    for epoch, _ in enumerate(train_iterator):
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if args.model_type in ["bert", "xlnet", "albert"]:
                ...
                inputs["token_type_ids"] = None  # Exclude token_type_ids for models that don't use it

                # XLM, DistilBERT, RoBERTa, and XLM-RoBERTa don't use segment_ids
            inputs.pop("position_ids", None)  # Remove position_ids if present in the inputs
...
def evaluate(args, model, tokenizer, prefix="", eval_split="dev"):
    ...
    for eval_task, eval_output_dir in zip(eval_task_names, eval_outputs_dirs):
        ...
        logger.info(f"***** {eval_task} {eval_split} results_try {prefix} *****")
...
def load_and_cache_examples(args, task, tokenizer, evaluate=False, data_split="train"):
    ...
    if os.path.exists(cached_features_file) and not args.overwrite_cache:
        ...
        if task == "winogrande" or task == "medqa":
...
def main():
    ...
    parser.add_argument("--config",
                        ...
                        default="/home/lw754/L101/configs/medqa.jsonnet",
                        help="Main config file with basic arguments.")
    parser.add_argument("--output_dir",
                        "-o",
                        type=os.path.abspath,
                        default="/home/lw754/L101/results_try",
